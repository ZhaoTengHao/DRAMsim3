...
class PyCallbackHandler {
    ...
    py::class_<MemorySystem>(m, "MemorySystem")
        ...
        .def("AddTransactionID", &MemorySystem::AddTransactionID)
    ...
    py::class_<Transaction>(m, "Transaction")
        .def_readonly("id", &Transaction::id)
        .def_readonly("addr", &Transaction::addr)
        .def_readonly("added_cycle", &Transaction::added_cycle)
        .def_readonly("complete_cycle", &Transaction::complete_cycle)
        .def_readonly("is_write", &Transaction::is_write);
}
